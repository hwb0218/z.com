...
export default function SignupModal() {
  const [state, submitAction, isPending] = useActionState(signupAction, {
    message: null
  });
        ...
        <div className={style.modal}>
          ...
          <form action={submitAction}>
            ...
            <div className={style.modalFooter}>
              <button type="submit" disabled={isPending} className={style.actionButton}>
                가입하기
              </button>
              <div className={style.error}>{showErrorMessage(state?.message)}</div>
            </div>
          </form>
        </div>
      </div>
